...
{
    /// <summary>
    /// <para>Attributes inheriting from this class will be used as rules by <see cref="Construct"/>/>
    /// when constructing a concrete instance</para>
    /// 
    /// Rules inheriting from <see cref="IActivateAnythingFindConcreteTypeRule"/> are concerned 
    /// with where to look (e.g. which assemblies or namespaces) for a concrete type
    /// </summary>
    [AttributeUsage(AttributeTargets.Class,Inherited = true,AllowMultiple = true)]
    public abstract class ActivateAnythingFindConcreteTypeRuleAttribute : Attribute, IActivateAnythingFindConcreteTypeRule, IActivateAnythingFindConcreteTypeByNameRule
    {
        /// <summary>
