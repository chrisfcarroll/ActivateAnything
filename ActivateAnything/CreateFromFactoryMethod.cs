...
namespace ActivateAnything
{
    ...
    public class CreateFromFactoryMethod : Attribute, IActivateInstanceRule
    {
        ...
        ///     The class where the factory method can be found.
        ///     If <paramref name="factoryMethodName" /> is not static then it must be possible to create an instance (for
        ///     instance,
        ///     by calling a constructor with no parameters, or with parameters we can recursively create)
        /// </param>
        ...
        ///     If no <see cref="factoryClass" /> was specified in the constructor, then the <c>searchAnchor</c>
        ///     must declare a method named <see cref="factoryMethodName" />.
        /// </param>
