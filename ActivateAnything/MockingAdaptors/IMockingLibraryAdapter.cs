...
namespace ActivateAnything
{
    ...
    public interface IMockingLibraryAdapter
    {
        ...
        ///<summary>
        /// This method will be called whenever <see cref="CreateFromMockAttribute.MockingLibraryAdapter"/> is set, to ensure that the required mocking library is working.
        /// </summary>
