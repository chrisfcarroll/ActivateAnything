...
namespace ActivateAnything
{
    ...
    /// </list>
    /// </summary>
    public class FindInAssembliesReferencedByAnchorAssembly : ActivateAnythingFindConcreteTypeRuleAttribute
    {
        /// <summary>
        ...
        public override Type FindTypeAssignableTo(Type type, IEnumerable<Type> typesWaitingToBeBuilt = null, object anchor = null)
        {
            return anchor == null 
                ? null 
                : FindType(
        ...
        public override Type FindTypeAssignableTo(string typeName, IEnumerable<Type> typesWaitingToBeBuilt = null, object anchor = null)
        {
            return anchor == null
                       ? null
                       : FindType(
