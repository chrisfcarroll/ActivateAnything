...
namespace FixtureBase
{
    ...
    {
        /// <summary>
        ///     A <see cref="FakeHttpClient" /> which can be setup for expectations, return results, and be verified.
        ...
        /// <inheritdoc />
        /// <summary>
        ///     Create an instance of <see cref="FixtureBaseWithDbAndHttpFor{T}" /> with a <see cref="FakeHttpClient" />
        ///     already added to <see cref="FixtureBase.Instances" />
        /// </summary>
    ...
    {
        /// <summary>
        ///     A <see cref="FakeDbConnection" /> which can be setup for expectations, return results, and be verified.
        ///     This is added to <see cref="FixtureBase.Instances" /> for use by <see cref="FixtureBase.Activator" /> in
        ///     constructing the <see cref="FixtureBaseFor{T}.UnitUnderTest" />
        /// </summary>
        ...
        /// <inheritdoc />
        /// <summary>
        ///     Create an instance of <see cref="FixtureBaseWithDbAndHttpFor{T}" /> with a <see cref="FakeDbConnection" />
        ///     already added to <see cref="FixtureBase.Instances" />
        /// </summary>
    ...
    public class FixtureBaseWithDbAndHttpFor<T> : FixtureBaseFor<T>
    {
        ...
        /// <summary>
        ///     Create an instance of <see cref="FixtureBaseWithDbAndHttpFor{T}" /> with a <see cref="FakeDbConnection" />
        ///     and a <see cref="FakeHttpClient" /> already added to <see cref="FixtureBase.Instances" />
        /// </summary>
        protected FixtureBaseWithDbAndHttpFor()
        {
            Instances.Add(Db);
